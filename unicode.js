...
let myFirstCodePoint = inputString2.charCodeAt(0);
let myLastCodePoint = inputString2.charCodeAt(5);

let swappedString = String.fromCharCode(myLastCodePoint, 97, 117, 110,99,myFirstCodePoint ) // Your code here
